...
// Define an interface for children that accept the isHovered prop.
interface WithIsHoveredProps {
    ...
    >
      {Children.map(children, (child) =>
        React.isValidElement(child)
          ? cloneElement(child as React.ReactElement<WithIsHoveredProps>, { isHovered })
          : child
      )}
    </motion.div>
  );
